...
const Testimonial = () => {
    return (
        <div className='my-24'>
            ...
            <p>What Out Client Say after buing Product</p>
            </div>
        <div class="container mx-auto grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 xl:px-20 px-10 py-20 gap-6">
            <div>
                <div class="group w-full bg-white dark:bg-gray-800  relative flex flex-col items-center hover:bg-indigo-700 cursor-pointer shadow-md md:p-12 p-6">
